...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull LinearLayout rootView, @NonNull Button buttonLog,
      @NonNull Button buttonSign, @NonNull EditText etPassword, @NonNull EditText etUsername) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((LinearLayout) rootView, buttonLog, buttonSign, etPassword,
          etUsername);
    }
